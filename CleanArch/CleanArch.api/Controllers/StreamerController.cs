...
using CleanArch.Application.Features.Streamers.Commands.DeleteStreamer;
using CleanArch.Application.Features.Streamers.Commands.UpdateStreamer;
using MediatR;
...
namespace CleanArch.API.Controllers
{
    ...
    public class StreamerController : ControllerBase
    {
        ...
        {
            var command = new DeleteStreaemerCommand() { Id = id };
            await _mediator.Send(command);
